...
import { BANK_DATA, BANK_NAMES } from '../../shared/constants/banks';
...
const DocumentAnalysis: React.FC<DocumentAnalysisProps> = ({
  ...
  // formatAmount вынесен в shared/lib/amounts (импортируется выше).
  // parseAmount/handleAmountChange/handleAmountBlur удалены как мёртвый код.
